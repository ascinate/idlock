                    ...
                    <div className='container mx-auto py-4'>
                        <div className='container-hero flex items-center gap-52 '>
                            ...
                            <div className='hero-img-containter'>
                                ...
                                <img src={ithree} alt="b" className='ithree'/>
                                <img src={ifour} alt="b" className='ifour'/>
                                <img src={ione} alt="g"  className='ione-face'/>
                                <img src={isix} alt="h"  className='isix'/>
                            </div>
                        </div>
                    </div>
                </section>
